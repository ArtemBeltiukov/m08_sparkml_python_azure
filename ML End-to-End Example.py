...
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/fuskerr@gmail.com/winequality_red.csv", sep=';')
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/fuskerr@gmail.com/winequality_white.csv", sep=';')
...
table_path = "dbfs:/fuskerr@gmail.com/delta/wine_data"
...
import os
os.environ["DATABRICKS_TOKEN"] = "dapif38de3306cb9da296d4e9e7f5189445d-2"
...
def score_model(dataset):
  url = 'https://adb-832562341706797.17.azuredatabricks.net/model/wine_quality/2/invocations'
